...
public class TestSuitePage extends FormPage {
	...
	//private TestTemplate fTestTemplate;
	...
	private void fillBody(IManagedForm managedForm, FormToolkit toolkit) {
		...
		// body.setBackground(new Color(), 255, 0,0));
		...
		//createTestTemplate(managedForm,toolkit,body);
		
	}
/*      TEMPLATE
private void createTestTemplate(IManagedForm managedForm, FormToolkit toolkit, Composite body){
	fTestTemplate= new TestTemplate(body,this,toolkit, ExpandableComposite.TITLE_BAR | Section.DESCRIPTION);
	managedForm.addPart(fTestTemplate);
}
*/
