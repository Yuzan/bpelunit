...
public class TemplateVelocityComponent extends StyledText  {

	private Thread threadA;
	//http://www.wikilengua.org/index.php/Lista_de_colores
	private static Color creference = new Color(null, 255, 191, 0);//Ambar
	private static Color cifsetstop = new Color(null,102,2,60);//Purpura de Tiro
	...
	public TemplateVelocityComponent(Composite parent, int style) {
		super(parent, style);
		// TODO Auto-generated constructor stub
		
			threadA = new Thread(new VelocityHighlightTask(this), "HiloA");
			threadA.start();
...
class VelocityHighlightTask implements Runnable, ParserVisitor {
	...
	public VelocityHighlightTask(StyledText styledText) {
